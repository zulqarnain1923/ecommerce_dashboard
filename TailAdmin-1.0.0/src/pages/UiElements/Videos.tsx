...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Dashboard - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Dashboard - React.js Tailwind CSS Admin Dashboard Template"
      />
