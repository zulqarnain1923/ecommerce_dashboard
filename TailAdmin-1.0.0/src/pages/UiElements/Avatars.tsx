...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Dashboard - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Dashboard - React.js Tailwind CSS Admin Dashboard Template"
      />
